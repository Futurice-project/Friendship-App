...
import SignUpMatching from '../views/SignUp/MatchingAgreement';
import SignUpLocation from '../views/SignUp/Locations';
import SignUpPersonality from '../views/SignUp/Personalities';
import ChatView from '../views/Chat/ChatView';
import ChatRequest from '../views/Chat/ChatRequest';
import SignUpYeahAndNaah from '../views/SignUp/LoveAndHate';
